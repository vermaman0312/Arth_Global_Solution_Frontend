  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible ? "bg-background-secondary" : "bg-background-secondary",
        className
      )}
    >
      {children}
...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "absolute inset-0 hidden flex-1 flex-row items-center justify-end space-x-2 pr-2 text-sm font-medium text-zinc-600 transition duration-200 hover:text-zinc-800 lg:flex lg:space-x-2",
        className
      )}
    >
      {items.map((item, idx) => (
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full h-[calc(100vh-120px)] overflow-y-auto scrollbar-hidden flex-col items-start justify-start gap-4 rounded-lg bg-background-secondary px-4 py-8 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] dark:bg-neutral-950",
            className
          )}
        >
          {children}
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <X className="text-foreground-secondary" onClick={onClick} />
  ) : (
    <Menu className="text-foreground-secondary" onClick={onClick} />
  );
};
