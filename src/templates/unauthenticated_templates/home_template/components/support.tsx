  ...
  return (
    <div className="p-4 rounded-3xl flex flex-col items-center justify-center gap-2">
      <CustomLampSection className="flex flex-col items-center justify-center gap-2">
        <CustomLabel className="text-[#DAC5A7] text-center text-xl md:text-4xl font-medium tracking-tight">
          ✅ 360° Support
        </CustomLabel>
        <CustomLabel className="text-[#DAC5A7] text-center text-xl md:text-4xl font-medium tracking-tight">
        ...
        <button className="text-xs bg-blue-900 text-foreground-primary p-2 px-4 rounded-2xl font-light shadow-md">Learn more</button>
      </CustomLampSection>
    </div>
  );
};
